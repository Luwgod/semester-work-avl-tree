...
| :---          |   ---:    |  ---:                 |
| Александр     | 50        |  _кодер_              |
| Фархат        | 40        |  _Документатор_       |
| Владимир      | 10        |  _Составитель отчетов_|
...
Запуск контрольных тестов осуществляется в 2 этапа:
1) Генерация контрольных тестов файлом generate_csv_dataset.py
2) Собственно запуск тестов
